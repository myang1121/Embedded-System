...
/*
	...
	TEST_LOOP:
		BL morse_digit // Takes in n from 0 to 9, starting w/ #9
		BL TEST_DELAY
		SUB R0, #1 // Decrement by 1
		BGE TEST_LOOP // If counter did get less than 0, break
*/
	BL morse_digit // Takes in n from 0 to 9
	B forever // End
/*
TEST_DELAY:
	PUSH {R1}
...
DIGIT_1:
	...
	BL DASH
	BL DASH
	POP {R4, PC} // After program runs, enter infinite loop
